...
public class PublicationDataModel extends AbstractDataModel {
    ...
    public void resetParentSearchFilters() {
        ...
        idFilter.setNativeSearchFieldName("PUBLICATION.DATA_SET_ID");
        idFilter.setSearchFieldName("Publication.dataSetId");
    ...
    public TableModel getTableModel() {
        ...
        dtm.addColumn("ID");
        dtm.addColumn(Localizer.localize("UI", "SourceDataModelPublicationNameColumnName"));
        dtm.addColumn(Localizer.localize("UI", "SourceDataModelPublicationTypeColumnName"));
