...
public class CloseTabPaneUI extends BasicTabbedPaneUI {
    ...
    public CloseTabPaneUI() {
        ...
        try {
            closeImgI = ImageIO.read(getClass()
    ...
    protected void layoutLabel(int tabPlacement, FontMetrics metrics, int tabIndex, String title,
        ...
        SwingUtilities
            .layoutCompoundLabel((JComponent) tabPane, metrics, title, icon, SwingUtilities.CENTER,
                SwingUtilities.LEFT, SwingUtilities.CENTER, SwingUtilities.CENTER, tabRect,
    ...
    protected void updateCloseIcon(int x, int y) {
        if (Main.getInstance().getDesktopTabbedPane().getTabCount() > 0) {
            if (overTabIndex != -1) {
    ...
    protected void installKeyboardActions() {
        ...
        SwingUtilities
            .replaceUIInputMap(tabPane, JComponent.WHEN_ANCESTOR_OF_FOCUSED_COMPONENT, km);
    ...
    protected void uninstallKeyboardActions() {
        ...
        SwingUtilities
            .replaceUIInputMap(tabPane, JComponent.WHEN_ANCESTOR_OF_FOCUSED_COMPONENT, null);
    ...
    protected void paintTab(Graphics g, int tabPlacement, Rectangle[] rects, int tabIndex,
        ...
        paintTabBorder(g, tabPlacement, tabIndex, tabRect.x, tabRect.y, tabRect.width,
            tabRect.height, isSelected);

        String title = tabPane.getTitleAt(tabIndex);
        Font font = tabPane.getFont().deriveFont((Main.MAC_OS_X ? Font.BOLD : Font.PLAIN), 12.0f);
        ...
        public void layoutContainer(Container parent) {
            ...
            if (selectedIndex < 0) {
                ...
                if (numChildren > 0) {
                    ...
                    cw = bounds.width - insets.left - insets.right - contentInsets.left
                        - contentInsets.right;
    ...
    private class ScrollableTabSupport implements ChangeListener {
        ...
        ScrollableTabSupport(int tabPlacement) {
            ...
            if (Main.getInstance() != null) {
                Main.getInstance().addDesktopPopupComponent(tabPanel);
            }
        ...
        public void setLeadingTabIndex(int tabPlacement, int index) {
            ...
            if ((viewSize.width - tabViewPosition.x) < viewRect.width) {
                ...
                Dimension extentSize =
                    new Dimension(viewSize.width - tabViewPosition.x, viewRect.height);
    ...
    private class ScrollableTabPanel extends JPanel implements UIResource {
        ...
        public void paintComponent(Graphics g) {
            ...
            if (tabCount > 0 && tabPane.getSelectedIndex() != -1) {
                ...
                try {
                    ...
                    // do nothing... there is a bug here that happens sometimes.
                    // needs to be caught.
                }
                g.setColor(shadow);
                if (Main.WINDOWS) {
    ...
    class MyMouseHandler extends MouseHandler {
        ...
        public void mouseReleased(MouseEvent e) {
            ...
            if (overTabIndex == -1) {
                if (e.isPopupTrigger())
                    ((CloseTabbedPane) tabPane).firePopupOutsideTabEvent(e);
                return;
            }
