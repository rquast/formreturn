...
public class ModeCreateFigBarcodeForSegment extends ModeCreate {
    ...
    public ModeCreateFigBarcodeForSegment() {
        setDefaultWidth(0);
        setDefaultHeight(0);
    }
    ...
    @Override public Fig createNewItem(MouseEvent me, int snapX, int snapY) {
        try {
            FigBarcode figBarcode =
                new FigBarcode(snapX, snapY, "Code 128", "My Barcode", 0.8, true, true);
            figBarcode.setAllowFormIDBarcode(false);
            return figBarcode;
        } catch (Exception e) {
