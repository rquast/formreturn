...
public class AddNewUserDialog extends JDialog {
    ...
    private ManageDatabaseUsers manageDatabaseUsers;

    public AddNewUserDialog(Frame owner) {
        super(owner);
        initComponents();
        getRootPane().setDefaultButton(addUserButton);
    }

    public AddNewUserDialog(ManageDatabaseUsers manageDatabaseUsers, String databaseName) {
        super(manageDatabaseUsers);
        initComponents();
        this.databaseName = databaseName;
        this.manageDatabaseUsers = manageDatabaseUsers;
        getRootPane().setDefaultButton(addUserButton);
    }
    ...
    private void addUserButtonActionPerformed(ActionEvent e) {
        ...
        if (!(Misc.validateSQL92Identifier(username))) {
            Misc.showErrorMsg(this,
                Localizer.localize("Server", "AddNewUserInvalidUserNameMessage"),
                Localizer.localize("Server", "AddNewUserInvalidUserNameTitle"));
            return;
        }

        if (!(password.equals(confirmPassword))) {
            Misc.showErrorMsg(this,
                Localizer.localize("Server", "AddNewUserPasswordConfirmationFailureMessage"),
                Localizer.localize("Server", "AddNewUserPasswordConfirmationFailureTitle"));
            return;
        }

        try {
            ServerGUI.getInstance().getDatabaseServer().getDatabaseInstance(databaseName)
                .addDatabaseUser(username, password);
            manageDatabaseUsers.updateDatabaseUsersList();
            Misc.showSuccessMsg(this,
                String.format(Localizer.localize("Server", "AddNewUserSuccessMessage"), username));
            dispose();
    ...
    private void initComponents() {
        ...
        this.setTitle(Localizer.localize("Server", "AddNewUserDialogTitle"));
        ...
        //======== dialogPane ========
        {
            ...
            //======== contentPanel ========
            {
                ...
                usernameLabel.setText(Localizer.localize("Server", "AddNewUserUsernameLabel"));
                ...
                passwordLabel.setText(Localizer.localize("Server", "AddNewUserPasswordLabel"));
                ...
                confirmPasswordLabel
                    .setText(Localizer.localize("Server", "AddNewUserConfirmPasswordLabel"));
            ...
            //======== buttonBar ========
            {
                ...
                //---- addUserButton ----
                addUserButton.setFont(UIManager.getFont("Button.font"));
                addUserButton.addActionListener(new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
                        addUserButtonActionPerformed(e);
                    }
                });
                addUserButton.setText(Localizer.localize("Server", "AddNewUserAddUserButtonText"));
