...
public class ProcessingStatusDialog extends JDialog implements MessageNotification {
    ...
    public ProcessingStatusDialog(Frame owner) {
        super(owner);
        initComponents();
        addAbortListener();
    }

    public ProcessingStatusDialog(Dialog owner) {
        super(owner);
        initComponents();
        addAbortListener();
    }
    ...
    /* (non-Javadoc)
     * @see com.ebstrada.formreturn.manager.ui.dialog.MessageNotification#isInterrupted()
     */
    ...
    /* (non-Javadoc)
     * @see com.ebstrada.formreturn.manager.ui.dialog.MessageNotification#setInterrupted(boolean)
     */
