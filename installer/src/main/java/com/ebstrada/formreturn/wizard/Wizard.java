...
import com.ebstrada.formreturn.installer.Main;
  ...
  void close(int code) {
    ...
    if (code == 0) {
      ...
      if (mainInstance.launchCheckBox.isSelected() == true) {
        if (Main.WINDOWS) {
          try {
            String[] cmdArray = { mainInstance.outputDir.getPath() + "/formreturn.exe" };
          ...
          try {
            String[] cmdArray = { "open", mainInstance.outputDir.getPath() + "/FormReturn.app" };
            Runtime.getRuntime().exec(cmdArray);
          } catch (Exception ex) {
            System.out.println(ex.getMessage());
            ex.printStackTrace();
          ...
          try {
            String[] cmdArray = { mainInstance.outputDir.getPath() + "/formreturn.sh" };
            Runtime.getRuntime().exec(cmdArray);
          } catch (Exception ex) {
            System.out.println(ex.getMessage());
            ex.printStackTrace();
      ...
      if (mainInstance.shortcutCheckBox.isSelected() == true) {
        if (Main.WINDOWS) {
          try {
            ...
            try {
              fout = new FileOutputStream(mainInstance.outputDir.getPath()
                  + "/extras/shortcut/Shortcut.bat");
              new PrintStream(fout)
                  .println("\""
                      + mainInstance.outputDir.getPath()
                      + "\\extras\\shortcut\\Shortcut.exe\" /d:\"FormReturn\" /f:\"%USERPROFILE%\\Desktop\\FormReturn.lnk\" /a:c /t:\""
                      + mainInstance.outputDir.getPath() + "\\formreturn.exe\"");
              fout.close();
            } catch (IOException e) {
            ...
            String[] cmdArray = { mainInstance.outputDir.getPath()
                + "/extras/shortcut/Shortcut.bat" };
